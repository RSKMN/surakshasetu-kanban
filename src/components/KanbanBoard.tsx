...
export default function KanbanBoard({
  stickyColor,
  currentUserId,
}: { stickyColor: string; currentUserId: string }) {
  ...
  // Drag-and-drop (kept; actions provide alternative)
  function localMove(
                        ...
                        <Draggable draggableId={t.id} index={idx} key={t.id}>
                          {(drag) => (
                            ...
                            >
                              ...
                              {t.description ? <div className="card-desc">{t.description}</div> : null}
                              ...
                              <div className="card-meta" onClick={(e) => e.stopPropagation()}>
                                ...
                                <div className="actions-mini">
                                  {t.status !== "todo" && (
                                    <button className="mini" onClick={() => moveTo(t.id, "todo")}>To Do</button>
                                  )}
                                  {t.status !== "in_progress" && (
                                    <button className="mini" onClick={() => moveTo(t.id, "in_progress")}>In Prog</button>
                                  )}
                                  {t.status !== "done" && (
                                    <button className="mini" onClick={() => moveTo(t.id, "done")}>Done</button>
                                  )}
                                </div>
                              </div>
                            </div>
